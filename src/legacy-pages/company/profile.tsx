					...
					<Tab key={"gen-info"} title={<h2 className="text-lg font-semibold">General Information</h2>}>
						...
						<Card
							...
							<CardBody>
								...
								<div className="my-2">
									<Textarea label="Description" value={companyInfo?.description} isReadOnly />
								</div>
								<Divider />
							</CardBody>
						</Card>
					...
					<Tab key={"account-mgmt"} title={<h2 className="text-lg font-semibold">Account Management</h2>}>
						...
						<div className="my-5">
							...
							<div className="space-y-4 my-2">
								...
								<p className="text-[14px] md:w-[85%]">
									Deactivating your account is a permanent action, rendering it inaccessible. Prior to confirming, ensure you've saved any essential information. Once deactivated, contact our support
									team for assistance or reactivation inquiries
								</p>
