...
const LoanReports: NextPageWithLayout = () => {
	...
	return (
		<>
			<Head>
				<title>Loan Report - SaaStain</title>
			</Head>
			<Breadcrumbs>
										...
										<Card className="w-full px-5">
											...
											<CardBody className="">
												...
												<div className="flex items-center justify-center">
													<Button color="primary" variant="light">Add Payment Method</Button>
												</div>
											</CardBody>
											<CardFooter>
												<Button className="w-full" color="primary">
...
LoanReports.getLayout = (c) => <AppLayout>{c}</AppLayout>;
