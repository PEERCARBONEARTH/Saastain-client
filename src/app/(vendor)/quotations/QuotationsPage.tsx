...
import { HiOutlineFilter, HiOutlineRefresh, HiDotsVertical, HiDocumentText } from "react-icons/hi";
	...
	return (
		<>
			...
			<div className="mt-4 space-y-2">
				<h1 className="text-green-800 font-bold text-2xl">Quotations</h1>
				<p className="text-sm">
				...
				<div className="flex items-center justify-end w-full">
					<Dropdown>
						...
						<DropdownMenu className="saastain font-nunito" aria-label="Quote Actions">
							<DropdownItem onPress={() => router.push("/quotations/details/1")} key="view">
								View Quote
							</DropdownItem>
							<DropdownItem key="edit">Edit Quote</DropdownItem>
						</DropdownMenu>
					</Dropdown>
				</div>
			</CardHeader>
