...
const DeliveryVehiclesTab = ({ branchesData }: IProps) => {
	...
	const {
		...
		!userInfo?.company?.id ? null : [IApiEndpoint.MOBILITY_GET_BY_COMPANY_PAGINATED, { page, limit, companyId: userInfo?.company?.id, search, branch: "", category: FleetAddVariant.DELIVERY }],
		swrFetcher,
		...
		<div className="w-full">
			...
			<div className="mt-5">
				<AppTable<IFleetMobility>
					...
					emptyContent="No Delivery Vehicles Found"
...
export default DeliveryVehiclesTab;
