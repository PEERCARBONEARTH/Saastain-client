...
import { BreadcrumbItem, Breadcrumbs, Button, Card, CardBody, CardFooter, CardHeader, Chip, Divider, Image, Progress, Dropdown, DropdownItem, DropdownMenu, DropdownTrigger, Avatar } from "@nextui-org/react";
				...
				<div className="">
					<div className="w-full flex items-center justify-between">
						...
						<div className="flex items-center gap-2">
							...
							<div className="py-3 px-4 border border-dashed rounded-xl">
								<p className="text-sm text-center">Pending Review By Vendor</p>
							</div>
						</div>
					</div>
				</div>
							...
							<CardBody>
								<TimelineItem title="Request for Quotation" description="SME Name has requested for a quotation  for this product" timelineDate="July 26,2024 10:34 PM" completed>
									<div className="pl-6 pt-6">
										<TimelineItem title="Scheduling a visit" description="SME,Vendor  will be called by peer carbon . Btn-(Peer Carbon)-Add Visit Details (time,date,location,pc  representive)" timelineDate="July 26,2024 10:34 PM" stepIcon={<CalendarClock className="shrink-0 size-4 mt-1" />} completed />
										<TimelineItem title="Visit scheduled(Vendor,SME)" description="SME,Vendor  will be called by peer carbon . Btn-(Peer Carbon)-Add Visit Details (time,date,location,pc  representive)" timelineDate="July 26,2024 10:34 PM" stepIcon={<CalendarCheck2 className="shrink-0 size-4 mt-1" />} completed={false} />
										<TimelineItem title="Confirm Visit(Peer Carbon)" description="SME,Vendor  will be called by peer carbon . Btn-(Peer Carbon)-Add Visit Details (time,date,location,pc  representive)" timelineDate="July 26,2024 10:34 PM" stepIcon={<ClipboardCheckIcon className="shrink-0 size-4 mt-1" />} completed={false} />
										<TimelineItem title="Update Quotation" description="SME,Vendor  will be called by peer carbon . Btn-(Peer Carbon)-Add Visit Details (time,date,location,pc  representive)" timelineDate="July 26,2024 10:34 PM" stepIcon={<ClipboardPenLine className="shrink-0 size-4 mt-1" />} completed={false} />
									</div>
								</TimelineItem>
                                <TimelineItem title="Order has been  placed" description="SME,Vendor  will be called by peer carbon . Btn-(Peer Carbon)-Add Visit Details (time,date,location,pc  representive)" timelineDate="July 26,2024 10:34 PM" stepIcon={<ClipboardPenLine className="shrink-0 size-4 mt-1" />} completed={false} />
							</CardBody>
						</Card>
					</div>
				</div>
