...
const alertVariants = cva("relative w-full rounded-lg border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-gray-500 [&>svg~*]:pl-7", {
	variants: {
		variant: {
			default: "bg-background text-gray-500",
			destructive: "border-red-500/50 text-destructive dark:border-destructive [&>svg]:text-red-500",
		},
	},
	defaultVariants: {
		variant: "default",
