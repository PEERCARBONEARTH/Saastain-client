					...
					<div className="flex gap-2 grid grid-cols-3 grid-rows-1">
						<div>
							...
							<p className="text-3xl pt-6 px-6">
								100 <span className="text-primary-grey">tC02e</span>
							</p>
						</div>
						...
						<div> 
							...
							<p className="text-3xl">
								7 <span className="text-primary-grey">tC02e</span>
							</p>
						</div>
						{/* <Divider orientation="vertical" /> */}
						<div>
							...
							<p className="text-3xl ">
								10 <span className="text-primary-grey">tC02e</span>
							</p>
						</div>
					</div>
				</CardBody>
			...
			<div className="p-12 max-w-[full] gap-2 grid grid-cols-12 grid-rows-1">
				<Card className="col-span-12 sm:col-span-4 h-[195px]">
					<CardBody>
						<div className="flex justify-between items-center">
							<h3>Net Zero</h3>
							<Image src="/images/external-link.svg" width={20} height={20} alt="" className="ml-auto" />
						</div>

						<div className="items-center flex py-8">
							<Image src="/images/arrow-circle-up.svg" alt="" />
				...
				<Card className="col-span-12 sm:col-span-4 h-[195px]">
					<CardBody>
						...
						<div className="items-center flex py-8">
							<Image src="/images/arrow-circle-down.svg" alt="" />
