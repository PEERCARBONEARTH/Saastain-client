...
const LoanApplication: NextPageWithLayout = () => {
						...
						<form onSubmit={formMethods.handleSubmit(onSubmit)}>
							...
							{currentStep === 2 && (
								<div className="">
									...
									<div className="mb-4">
										<div className="flex items-center gap-4 ">
											<AppInput label="How many full-time employees does the company have?" name="numberOfEmployees" placeholder="Number of Employees" type="number" control={formMethods.control} />
										</div>
									</div>
									<Spacer y={8} />
									<div>
...
LoanApplication.getLayout = (page) => <AppLayout>{page}</AppLayout>;
