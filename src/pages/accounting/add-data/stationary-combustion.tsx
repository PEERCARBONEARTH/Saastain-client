...
const StationaryCombustion: NextPageWithLayout = () => {
	...
	const { queryFuelsInfo, saveFuelsInfo } = useAccountingDataUtils();
	...
	const onConfim = async () => {
		...
		try {
			const resp = await saveFuelsInfo(dataToSave);
...
StationaryCombustion.getLayout = (page) => <AppLayout>{page}</AppLayout>;
