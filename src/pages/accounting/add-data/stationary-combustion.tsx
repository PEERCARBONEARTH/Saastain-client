				...
				<FormProvider {...formMethods}>
					<form onSubmit={formMethods.handleSubmit(onSubmit)}>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							<div className="mb-4">
								<div className="flex items-center gap-4 ">
									<AppSelect label="Equipment Name" name="emissionName" placeholder="Equipment Name" options={options} control={formMethods.control} />
								</div>
							</div>
                            </div>
							...
							<div className="mb-4">
								<div className="flex items-center gap-4 ">
									<AppSelect label="Fuel Unit" name="fuelUnit" options={options} placeholder="Select One" control={formMethods.control} />
								</div>
							</div>
