...
import { IScopeOne, IScopeOneFleet, IScopeOneFuels, IScopeOneFugitiveEmission, IScopeOneProcessEmission, IScopeTwo, ScopeOneCategory, ScopeOneComponentKeys, ScopeTwoCategory, ScopeVariant } from "@/types/Accounting";
